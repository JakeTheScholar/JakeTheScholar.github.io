...
// Isomorphic rules engine — shared between server and client
// This is the same logic as trading-command-center/js/rules.js

const Rules = {
  PRESETS: {
    apex_50k_eval: {
      name: 'Apex 50K Eval', startingBalance: 50000, profitTarget: 3000,
      trailingDrawdown: 2000, dailyLossLimit: null, consistencyPct: null,
      minTradingDays: 0, drawdownStopsAtTarget: true,
    },
    apex_50k_funded: {
      name: 'Apex 50K Funded (PA)', startingBalance: 50000, profitTarget: null,
      trailingDrawdown: 2000, dailyLossLimit: null, consistencyPct: 0.50,
      minTradingDays: 8, drawdownStopsAtTarget: false,
    },
    topstep_50k_normal: {
      name: 'Topstep 50K Normal XFA', startingBalance: 50000, profitTarget: null,
      trailingDrawdown: 2000, dailyLossLimit: 1000, consistencyPct: 0.50,
      minTradingDays: 5, minDayAmount: 150, drawdownStopsAtTarget: false,
    },
    topstep_50k_consistency: {
      name: 'Topstep 50K Consistency XFA', startingBalance: 50000, profitTarget: null,
      trailingDrawdown: 2000, dailyLossLimit: 1000, consistencyPct: 0.40,
      minTradingDays: 3, minDayAmount: null, drawdownStopsAtTarget: false,
    },
    mff_core_50k_eval: {
      name: 'MFF Core 50K Eval', startingBalance: 50000, profitTarget: 3000,
      trailingDrawdown: 2000, dailyLossLimit: null, consistencyPct: 0.50,
      minTradingDays: 5, drawdownStopsAtTarget: true,
    },
    mff_core_50k_funded: {
      name: 'MFF Core 50K Funded', startingBalance: 50000, profitTarget: null,
      trailingDrawdown: 2000, dailyLossLimit: null, consistencyPct: 0.40,
      minTradingDays: 5, minDayAmount: null, drawdownStopsAtTarget: true,
    },
    mff_rapid_50k_eval: {
      name: 'MFF Rapid 50K Eval', startingBalance: 50000, profitTarget: 3000,
      trailingDrawdown: 2000, dailyLossLimit: null, consistencyPct: 0.50,
      minTradingDays: 2, drawdownStopsAtTarget: true,
    },
    mff_rapid_50k_funded: {
      name: 'MFF Rapid 50K Funded', startingBalance: 50000, profitTarget: null,
      trailingDrawdown: 2000, dailyLossLimit: null, consistencyPct: null,
      minTradingDays: 0, drawdownStopsAtTarget: true,
    },
    alpha_50k_eval: {
      name: 'Alpha Futures 50K Eval', startingBalance: 50000, profitTarget: 3000,
      trailingDrawdown: 2000, dailyLossLimit: null, consistencyPct: 0.50,
      minTradingDays: 0, drawdownStopsAtTarget: true,
    },
    alpha_50k_funded: {
      name: 'Alpha Futures 50K Funded', startingBalance: 50000, profitTarget: null,
      trailingDrawdown: 2000, dailyLossLimit: 1000, consistencyPct: 0.40,
      minTradingDays: 0, drawdownStopsAtTarget: true,
    },
    lucid_50k_eval: {
      name: 'Lucid 50K Eval', startingBalance: 50000, profitTarget: 3000,
      trailingDrawdown: 2500, dailyLossLimit: null, consistencyPct: 0.50,
      minTradingDays: 2, drawdownStopsAtTarget: true,
    },
    lucid_50k_funded: {
      name: 'Lucid 50K Funded', startingBalance: 50000, profitTarget: null,
      trailingDrawdown: 2500, dailyLossLimit: null, consistencyPct: null,
      minTradingDays: 5, minDayAmount: 150, drawdownStopsAtTarget: true,
    },
  },
  ...
  compute(account, entries) {
    ...
    return {
      ...
      winRate, profitFactor, tradingDays, todayPnl,
